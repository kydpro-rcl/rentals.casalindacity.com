...
<div style="margin-top:50px;">
    ...
    <div class="gallery">
		...
		?>
            <li id="image_li_<?php echo $row['id']; ?>" class="ui-sortable-handle"><a href="javascript:void(0);" style="float:none;" class="image_link"><img src="images/<?php echo $row['img_name']; ?>" alt=""></a>
			<p style="padding:-5px; margin:-5px; font-size:10px;text-transform:uppercase;"><a href="#">Replace</a> - <a href="#">Delete</a></p></li>
        <?php } } ?>
        </ul>
    </div>
</div>
