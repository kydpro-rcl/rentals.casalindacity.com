 ...
 */
function O_GoT(_p){
	_d.write('<a href=\'javascript:O_LC()\'>'+ _p +'</a> <img src=\'/en_US/i/scr/sm_333_oo.gif\' alt=\'' + _p + '\' />');
	_fPe()
}
function PP_O_GoT(_p){
	_d.write('<a href=\'javascript:PP_O_LC()\'>'+ _p +'</a> <img src=\'/en_US/i/scr/sm_333_oo.gif\' alt="' + _p + '" />');
	_fPe()
}
function Mini_O_GoT(_p, base){
	if(base){
		_d.write('<span id=\'opLab\'><a href=\'javascript:PP_O_LC()\'><span>'+ _p +'</span> <img src=\'/en_US/i/scr/sm_333_oo.gif\' alt="' + _p + '" /></a></span>');	
	}
	else{
		_d.write('<span id=\'opLab\'><a href=\'javascript:O_LC()\'><span>'+ _p +'</span> <img src=\'/en_US/i/scr/sm_333_oo.gif\' alt="' + _p + '" /></a></span>');	
	}
	_fPe()
}