...
require_once('inc/all_files.php');
	if($_POST){
        ...
        switch($_POST['item']){        	case 1:/*crear una villa*/
                ...
                $msg='Villa successfully created';
		     break;
		     case 2:/*crear nuevo numero de documento*/
				...
				$table='doc_number';
                $msg='Document number successfully created';
		     break;
		     case 3:/*crear detalles de la construccion*/
		     $vi=$db->get_id($id=$_POST['villa_id'], $table='villa'); $villa_no=$vi['no'];
		     if(($_POST['year1']!='0000')&&($_POST['month1']!='00')&&($_POST['day1']!='00')){
		     ...
		     if(($_POST['year1']!='0000')&&($_POST['month1']!='00')&&($_POST['day1']!='00')){
				...
				$table='villa_details';
		        $msg='Construction details successfully created';
		     break;
		     case 4:/*crear una nueva deficiencia*/
				...
				$table='deficiencies';
		       	$msg='Deficiency successfully created';
		     break;
		     case 5:/*crear un nuevo mantenimiento*/
				...
				$table='maintenance';
                $msg='Maintenance successfully created';
		     break;	    }
