...
<p class="header">Search bookings per referral monthly</p>
<form method="post" action="search_bookings_referal_month.php" >
	...
	?>
	<select class='input' size=1 name='referal'>
	<?
...
<?php
		...
		$bookings_found=$data->booking_per_months_referral($month=$_POST['m'], $year=$_POST['y'], $id_referral=$_POST['referal']);
