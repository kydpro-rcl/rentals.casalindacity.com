...
<!--<img src="images/logo.gif" border="0" style="float:left"><br/>  -->
		...
		/*//=============================EXCURSIONS========================================================*/
		 ...
		 $estado=$status;
 		   ?>
	    <h2 >Editing booking <span style="color:black;">No.<?=$reference?></span> - Try and Buy - step 3</h2>
...
/*echo $_POST['promotion_code'];*/
			...
			<!--//   codigo para promotion code//-->
	      <hr />
	<form method="post" action="edit-bookingtb3.php">
	    ...
	    <!--TERMINA NUEVO CODIGO PARA LOS SERVICIOS-->
			...
			?>
               ...
               <tr>
	            ...
	            <tr>
					<td id="td" style="text-align:right;"><strong>GENERAL AMOUNT = </strong></td>
					<td id="td" style="text-align:right;"><? 
	           ...
	           <table width="400" style="border-bottom:1px solid #060; border-top:1px solid #060; border-left:1px solid #060; border-right:1px solid #060;">
				...
				switch ($status){
					case 38: echo "<span style='color:green;'>TB Checked in</span>";
							break;
					case 40: echo "<span style='color:#00F;'> TB Confirmed</span>";
							break;
					case 41: echo "<span style='color:#00F;'>TB Checked out</span>";
							break;
					case 39: echo "<span style='color:#FF0000;'>TB No Confirmed</span>";
							break;
				}
				echo $old_info[0]['dep'];
...
<? if ($_POST['vehicles']){
	...
	<input type="hidden" name="tbid" value="<?=$_POST['tbid'];?>" />
