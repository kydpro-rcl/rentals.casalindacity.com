...
if($_SESSION['villa_details']){
				  ...
				  <!--<tr>
					...
					<tr>
						<td class="thinfield">
							 ...
							 <input class="boton" style="margin-right:559px;" type="button" name="Cancel" value="Cancel" onclick="window.location = 'http://casalindacity.com' " />
							 <input type="submit" value="Pay Now" class="boton" /></p>
						</td>
					</tr>
				</table>
			</center>
	...
	<html>
		...
		<body>
		<div class="cuerpo">
		<p> Error no villa Selected; to try again, please <a href="../availability_result.php" alt="click to return">Click Here</a>
		 </div> 
		</body>
		</html>
		<?
