...
session_start();
$_GET['pasos']=5;
if (!$_SESSION['RCL5']=="rcladministraciones") die('Restricted area...');
unset($_SESSION['RCL3']); unset($_SESSION['RCL4']);
...
require_once('init.php');
	...
	//SECCION QUE NO PERMITE POST ESTA PAGINA DOS VECES.
	 if ($_POST['confirm']=="Check Out"){ //ONLY IF CONFIRM HAVE BEEN PRESSED
		  ...
		  /*===========================================END ACCOUNTING INFO=============================================================================================*/
				...
				# sendMail($body1, RESERVATIONS_EMAIL, "Booking No: ".$ref, "online.booking@casalindacity.com", "RCL Booking System");//send to reservations
				 ...
				 echo $body1;*/
			        ...
			        unset($_SESSION['RCL5']);//kill this page - PARA EVITAR REFRESCAR LA PAGINA CON POST;
	  ...
	  draw('booking_confirm_SE'); //presenta el formulario y detalles
