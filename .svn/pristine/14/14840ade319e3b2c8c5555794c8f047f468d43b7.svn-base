 ...
 if ($_SESSION['info']){
   if ($_POST){
	...
	<!--<img src="images/logo.gif" border="0" style="float:left"><br/>  -->
	    <h2 style="text-align:center; color:red;">Long Term Rental - Step 2</h2>
	 	     <hr />
	      <form method="post" action="long-term-book3.php" name="st">
	           ...
	           <tr><td id="td" colspan="4"><strong>Reservation Comment:</strong><br /><span style="color:#3b3838;"> <?=wordwrap($comment, 75, "\n", true);?> </span><?}?></td></tr>
				...
				switch ($status){
					...
					case 11: echo "<span style='color:#FF0000;'>Check out</span>";
						break;
					case 22: echo "<span style='color:green;'>Checking in-Long Owner</span>";
						break;
					case 23: echo "<span style='color:#00F;'>Confirmed-Long Owner</span>";
					        echo "<!--&nbsp;-&nbsp;<span style='color:green;'>Deposit</span>&nbsp;<input type=text name=deposit size=5 value=000.00>-->";
						break;
					case 24: echo "<span style='color:#FF0000;'>No confirmed-Long Owner</span>";
							//echo " - <span style='color:green;'>Deposit</span> <input type=text name=deposit size=5 value=000.00>";
						break;
					case 25: echo "<span style='color:#FF0000;'>Check out-Long Owner</span>";
						break;
				}
