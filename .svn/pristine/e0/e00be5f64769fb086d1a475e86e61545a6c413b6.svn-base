	    ...
	    <?if ($_SESSION['info']['level']<=5){?>
			   <!--// <li <? if ($_GET['p']=='h') echo 'class="actual"';?>><a href="home-welcome.php" accesskey="1"><span>Home</span></a>	</li>//-->
				...
				<li <? if ($_GET['p']=='c') echo 'class="actual"';?>><a href="new-client.php" accesskey="3"><span>Customers</span></a></li>
				 ...
				 <? } */?>
				 <? if ($_SESSION['info']['level']<=5){?>
					<li <? if ($_GET['p']=='v') echo 'class="actual"';?>><a href="view-villas.php" accesskey="6"><span>Ref., Owners, Villas</span></a></li>
				 <? } ?>
			...
			<div id="subnav" class="clearfix">
                ...
                <ul class="menu"> <!--VILLAS AND OWNERS MENU-->
                  ...
                  <?}?>
                   ...
                   <? if ($_SESSION['info']['level']==1){?>
	                    ...
	                    <!--<li <? ?>><a href="dis-villas.php" title="Disable a villa"><span>Delete villa</span></a></li>-->
                    <?}?>
                   ...
                   <? if ($_SESSION['info']['level']==1){?>
	                    ...
	                    <!--<li <? ?>><a href="dis-owner.php" title="Disable a Owner"><span>Delete Owner</span></a></li>-->
                     <?}?>
				...
				<?if (($_SESSION['info']['manager']==1)||($_SESSION['info']['report']!=0)){?>
	                ...
	                <ul class="menu"><!--TICKETS-->
						...
						<li <? if ($_GET['s']=='t.h') echo 'class="actual"';?>><a href="emainthistory.php" title="Completed"><span>Maint. request history</span></a></li>
	                </ul>
	                 <?}?>
				<? }?>
			</div>
