                             ...
                             if ($calendar_date==$inicio_date){
                          		switch ($status){
									  ...
									  case 37:  //*Buyer checked out-Short*/
                          		     ...
                          		     break;
										case 38:     //check in short term
	                          		     if ($estadia>1){ //BELOW SHOW ONLY IF STAYING IS MAYOR TO ONE NIGHT

	                          		    if ($_GET['inicio']){
                                  				$end_date="$ano-$mes-$i";
												echo "<td class='name_head' style=\"color:blue\" align=center title='Click for Ending day $i'  onclick=\"location.href='short-term-book.php?villa=".$_GET['villa']."&v2=".$result[$c]['id']."&start=".$_GET['inicio']."&end=$end_date'\" id=\"checkin\" onmouseout=\"this.style.backgroundColor=''\" onmouseover=\"this.style.backgroundColor='#f8b618';\">$letra50</td>";
											}else{
							 					 echo "<td align=center style=\"color:blue\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\"
	                          		     		onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkin\">$letra50<!--$ocup--></td>";
							 				}
	                          		     }else{     //BELOW IS SHOWING ONLY IF STAYING IS EQUAL TO A NIGHT
	                          		     	if ($_GET['inicio']){
	                          		     		$end_date="$ano-$mes-$i";
                          		     ...
                          		     break;
                          		     case 40:    //confirmed short term
	                          		     if ($estadia>1){//BELOW SHOW ONLY IF STAYING IS MAYOR TO ONE NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
											echo "<td class='name_head' style=\"color:blue\" align=center title='Click for Ending day $i'  onclick=\"location.href='short-term-book.php?villa=".$_GET['villa']."&v2=".$result[$c]['id']."&start=".$_GET['inicio']."&end=$end_date'\" id=\"reserved\" onmouseout=\"this.style.backgroundColor=''\" onmouseover=\"this.style.backgroundColor='#f8b618';\">$letra50</td>";
                                  			}else{
	                          		     	echo "<td align=center style=\"color:blue\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"reserved\">$letra50</td>";
	                          		     	}
	                          		     }else{ //BELOW IS SHOWING ONLY IF STAYING IS EQUAL TO A NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
                          		     ...
                          		     break;
                          		     case 39:  //transit short term
	                          		     if ($estadia>1){  //BELOW SHOW ONLY IF STAYING IS MAYOR TO ONE NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
                                            echo "<td class='name_head' style=\"color:blue\" align=center title='Click for Ending day $i'  onclick=\"location.href='short-term-book.php?villa=".$_GET['villa']."&v2=".$result[$c]['id']."&start=".$_GET['inicio']."&end=$end_date'\" id=\"transit\" onmouseout=\"this.style.backgroundColor=''\" onmouseover=\"this.style.backgroundColor='#f8b618';\">$letra50</td>";
                                  			}else{
	                          		     	echo "<td align=center style=\"color:blue\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"transit\">$letra50</td>";
	                          		     	}
	                          		     }else{ //BELOW IS SHOWING ONLY IF STAYING IS EQUAL TO A NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
                          		     ...
                          		     break;
                          		     case 41:  //checkout short term
	                          		     if ($estadia>1){ //BELOW SHOW ONLY IF STAYING IS MAYOR TO ONE NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
                                            echo "<td class='name_head' style=\"color:blue\" align=center title='Click for Ending day $i'  onclick=\"location.href='short-term-book.php?villa=".$_GET['villa']."&v2=".$result[$c]['id']."&start=".$_GET['inicio']."&end=$end_date'\" id=\"checkout\" onmouseout=\"this.style.backgroundColor=''\" onmouseover=\"this.style.backgroundColor='#f8b618';\">$letra50</td>";
                                  			}else{
	                          		     	echo "<td align=center style=\"color:blue\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkout\">$letra50</td>";
	                          		     	}
	                          		     }else{    //BELOW IS SHOWING ONLY IF STAYING IS EQUAL TO A NIGHT
	                          		     	if ($_GET['inicio']){
                                  			$end_date="$ano-$mes-$i";
	                             ...
	                             case 4:   //checkout   short term
	                              ...
	                              case 8:   //Long term rental check in
	                               ...
	                               case 33:   /*Buyer checked out-Short*/
	                                 ...
	                                 echo "<td align=center style=\"color:green\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkin\">$letra50</td>";
	                                 }
                                 	break;                //$ocupaciones=$ocup; $ocupaciones=0;
                                 case 40:    //confirmed short term
	                                  if ($result_fin==1){
	                                 echo "<td align=center style=\"color:green\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"reserved\">U</td>";
	                                 	...
	                                 	echo "<td align=center style=\"color:green\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"reserved\">$letra50</td>";
	                                 }
	                                 break;
                                 case 39:   //transit short term
	                                 if ($result_fin==1){
	                                 ...
	                                 echo "<td align=center style=\"color:green\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"transit\">$letra50</td>";
	                                 }
	                                 break;
	                             case 41:   //checkout   short term
	                                 if ($result_fin==1){
	                                 ...
	                                 echo "<td align=center style=\"color:green\" class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkout\">$letra50</td>";
	                                  }
	                                  break;
                 ...
                 case 33: /*Buyer checked out-Short*/
                  ...
                  break;
				   case 38: //check in  short term
	                  ...
	                  echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkin\">$letra50</td>";
	                  }
                  break;
                  case 40: //confirmed  short term
	                  if ($count_nights==($estadia-1)){
	                  ...
	                  echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"reserved\">$letra50</td>";
	                  }
                  break;
                  case 39: //transit   short term
                	if ($count_nights==($estadia-1)){
                 	echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"transit\">U</td>";
                 	 ...
                 	 echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"transit\">$letra50</td>";
                 	}
                  break;
                  case 41: //checkout  short term
                	if ($count_nights==($estadia-1)){
                 	echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkout\">U</td>";
                 	 ...
                 	 echo "<td align=center class=\"name_head\" align=center title=\"Click to see ref: $referencia\" onclick=\"reserva('reserva_details.php?id=".$ocup_id."','Details for Selection', $heightW, $widthW)\" id=\"checkout\">$letra50</td>";
                 	}
                  break;
              }
