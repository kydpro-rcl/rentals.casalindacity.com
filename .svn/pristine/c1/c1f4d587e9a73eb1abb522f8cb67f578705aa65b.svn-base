...
<head>
    ...
    <![endif]-->
    <!-- CSS3 ANIMATION -->
    <link rel="stylesheet" href="<?=$var_base?>css/animate.min.css">
    <!-- MAIN CSS -->
	<link rel="stylesheet" href="<?=$var_base?>css/style.css">
...
<header id="header">
	<div class="logo">
		<img src="<?=$var_base?>images/logo.png" alt="Logo" />
	</div>
</header>
 <!-- /END HEADER AREA -->
			...
			<ul class="slides">
				...
				<li class="slide">
					...
					<div class="flex-caption center">
						...
						<p class="animation fromBottom transitionDelay4 transitionDuration10">We offer safe well managed sub division with full services</p><br>
				...
				<li class="slide">
					...
					<div class="flex-caption center">
						...
						<p class="animation fromBottom transitionDelay4 transitionDuration10">Enjoy one of the most beautiful beaches in Dominican Republic full with bars and restaurants.</p><br>
...
<input type="hidden" name="show" value="1">
		  <input type="hidden" name="promotion_code" value="">
				...
				<form class="row" name="bookform" id="bookform" method="post" action="<?=$var_base?>index.php#content_starts">
			
				<div class="col-xs-12 col-sm-12 col-md-8">
					<div class="row">
						<div class="col-xs-12 col-sm-4 col-md-4">
							<div class="form-group">
								<!--<select name="beds" class="form-control styled-select" tabindex="1" onchange="window.location='index.php?beds='+this.value">-->
								<select name="beds" class="form-control styled-select" tabindex="1" required>
									<option value="2" >Bedrooms</option>
									<option value="2" <?php if($_POST['beds']==2){ echo 'Selected="selected"'; }?> <?php if($_GET['beds']==2){ echo 'Selected="selected"'; }?>>2</option>
									<option value="3" <?php if($_POST['beds']==3){ echo 'Selected="selected"'; }?> <?php if($_GET['beds']==3){ echo 'Selected="selected"'; }?>>3</option>
									<option value="4" <?php if($_POST['beds']==4){ echo 'Selected="selected"'; }?> <?php if($_GET['beds']==4){ echo 'Selected="selected"'; }?>>4</option>
									<option value="5" <?php if($_POST['beds']==5){ echo 'Selected="selected"'; }?> <?php if($_GET['beds']==5){ echo 'Selected="selected"'; }?>>5</option>									
									<option value="6" <?php if($_POST['beds']==6){ echo 'Selected="selected"'; }?> <?php if($_GET['beds']==6){ echo 'Selected="selected"'; }?>>6</option>
				...
				<!--<div class="col-xs-12 col-sm-4 col-md-3">
					<div class="row">
						...
						<!--<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<select name="custom-select-1" class="form-control styled-select" tabindex="1">
						...
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<select name="custom-select-2" class="form-control styled-select" tabindex="1">
				...
				<div class="col-xs-12 col-sm-4 col-md-2">
					<div class="form-group">
						<input type="text" name="promotion_code" <?php if($_POST['promotion_code']!=''){?> value="<?=$_POST['promotion_code']?>" <?php } ?> class="form-control" placeholder="Promotion ?">
					</div>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-2">
					<?php if($_GET['villa']!=''){
					...
					<nav class="navbar navbar-default">
					  <div class="container-fluid">
						...
						<div class="navbar-header">
						  ...
						  <a class="navbar-brand" href="<?=$var_base?>index.php">Home</a>
						</div>

						<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							<li ><a href="<?=$var_base?>index.php#amenities">Amenities <!--<span class="sr-only">(current)</span>--></a></li>
							<li><a href="<?=$var_base?>index.php#excursions">Excursions</a></li>
							<li><a href="<?=$var_base?>index.php#services">Services</a></li>
							<li><a href="<?=$var_base?>index.php#directions">Directions</a></li>
							<li><a href="http://casalindadr.com/realestatedr/">Sales</a></li>
