...
<table width="90%" align="center" style="background-color:#FFF;">
	<tr>
     <td >
        <p><span style="font-weight:bold;">CUSTOMER:</span><br/>
...
<table width="90%" align="center">
	<tr>
     ...
     <tr>
        ...
        LS <?=$_SESSION['noches_LS']?> x US$ <?=number_format($_SESSION['villa_details']['p_low'],2)?> = <br/>
        HS <?=$_SESSION['noches_HS']?> x US$ <?=number_format($_SESSION['villa_details']['p_high'],2)?> =<br/>
          <!--//codigo promotion//-->
        ...
        <span style="font-weight:bold;">Sub-Total =</span><br/>
         ...
         <!--SERVICES ADDITIONALS-->
           ...
           VAT-TAX <?=TAX_PERCENT?> =<br/>
		    <!--Service fee=<br/>-->
         <span style="font-weight:bold; text-transform:uppercase;">paid now <? if($_SESSION['cars']){ echo "WITHOUT CARS"; } ?>=</span>
         <?
...
<hr style="border: 1px solid #9c0000;"/>
    ...
    <?
    if($_SESSION['cars']){?>
           <h1 style="float:left; color:red; font-size:28px;">Vehicle rental is paid at check-in</h1>
		   <h1 style="text-align:right; color:black; clear:both;">Cost details</h1>
       <?
