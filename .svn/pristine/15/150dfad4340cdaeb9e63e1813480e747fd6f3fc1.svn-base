...
<!--<tr>
	...
	<h2 style="text-align:left; line-height:26px; margin-left:100px;">There has been a problem in the booking process.<br/> Please, try again.</h2>
<?php } else {
...
<br>
<a class="home"  id="CallsLink" href="../m.availability.php"><font color=blue><B>Click here to try again<B><font></a>
