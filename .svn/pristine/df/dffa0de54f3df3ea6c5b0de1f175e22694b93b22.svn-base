...
<?php
	...
	//-----------------------END HIGHT AND LOW SEASONS QUANTITY-----------------------------------------------------------------------------
			if ($night_qty>1){
              ...
              if ($night_qty<$price_settings['long_m_night']){ 
		            ...
		            foreach ($villas_for_rent AS $v){
					 ...
					 if ($night_qty>=$price_settings['mid_m_night']){ 
											...
											<div class="row padall">
											  ...
											  <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
												...
												<div>
												  <h4><!--<span class="fa fa-map-marker icon"></span>--> Villa
													<?=$d['no']?> <?php
																$txt_class='';//empty when return
																	...
																	?>																	
																	<span style="color:<?=$txt_class_color?>;font-weight:bold;margin-left:15px;"><?=$txt_class;?> <?php ?></span>
												  </h4>
												  <h4>
												  <?php 
												 ...
												 ?>
													<span style="color:#777;"><strike><?=number_format($precio_anteriorVPN)?></strike> </span>
												 <?php } ?>
												 
													<span style="color:#22ac22;"><?=number_format($avg_night)?></span> <small>avg/night</small> - 
												<?php if($precio_anteriorVPN!=$avg_night){	?>
													<span style="color:#777;"><strike><?=number_format($precio_total_anterior)?></strike> </span>
												<?php } ?>	
													<span style="color:#22ac22;"><?=number_format($total_amount)?> </span><small>Total (inc/tax)</small>
												  </h4>
