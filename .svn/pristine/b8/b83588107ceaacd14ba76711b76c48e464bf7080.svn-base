...
<input type="hidden" name="show" value="1">
		  <!--<input type="hidden" name="promotion_code" value="">-->
			...
			<form class="row" name="bookform" id="bookform" method="post" action="index.php#content_starts">
					...
					<nav class="navbar navbar-default">
					  <div class="container-fluid">
						...
						<div class="navbar-header">
						  ...
						  <a class="navbar-brand" href="http://casalindacity.com/rentals/index.php">Home</a>
						</div>

						<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							<li ><a target="_blank" href="http://casalindacity.com/rentals/index.php#amenities">Amenities <!--<span class="sr-only">(current)</span>--></a></li>
							<li><a target="_blank" href="http://casalindacity.com/rentals/index.php#excursions">Excursions</a></li>
							<li><a target="_blank" href="http://casalindacity.com/rentals/index.php#services">Services</a></li>
							<li><a target="_blank" href="http://casalindacity.com/rentals/index.php#directions">Directions</a></li>
