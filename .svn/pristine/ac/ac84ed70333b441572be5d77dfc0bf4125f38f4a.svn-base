...
if ($_SESSION['info']){
	if ($_SESSION['info']['level']<=2){
		...
		if($_POST){
         ...
         $_GET['id']=$_POST['id']; //in case the gets some errors
         ...
         //save event
            ...
            $create_event=$db->edit_event($_POST['id'], $_POST['name'], $_POST['start'], $_POST['end'], $_POST['qty'], $_POST['type'], $_POST['increase'], $_POST['status'], $date);
			$_GET['guardado']="This Special Event has been updated";
         }
		}

		display('special_events_edit');
	}else{
