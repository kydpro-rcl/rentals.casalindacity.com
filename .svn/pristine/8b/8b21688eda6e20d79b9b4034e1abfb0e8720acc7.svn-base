...
<div style="clear:both; width:600px;" >
  ...
  <div id="cal-legend" style="width:732px;">
   ...
   <td><div class="a key" style="background-color:#FFFFFF;"></div>
        ...
        <td align="right">Updated Live <strong><?=date("F j, Y, ");?>
<?php

?>
<?php

?> </strong><strong><div id="spanreloj" style="color:#444444; float:right; margin-left:3px;"><!--CLOCK APPER HERE--></div></strong> </td>
		</tr></table>
   </div>
</div>
...
<?php
 ...
 require_once('../init_bookings.php');
                ...
                for ($c=1;$c<=2; $c++){
                 ...
                 echo "<tr>";
                  for ($i=1;$i<=3; $i++){
                  		...
                  		if ($mes_display==13){                  			$mes_display=1;                  			$ano_display++;                  		}
