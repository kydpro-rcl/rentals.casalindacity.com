			...
			echo '<nightlyRates>';
				...
				echo '<nightlyOverrides>';
					echo '<override>';
						...
						echo '<nights>';
							echo '<range>';
								echo '<max>'.date('Y').'-05-01</max>';
								echo '<min>'.date('Y').'-09-31</min>';
							echo '</range>';
						echo '</nights>';
					echo '</override>';
					echo '<override>';
						...
						echo '<nights>';
							echo '<range>';
								echo '<max>'.date('Y').'-12-01</max>';
								echo '<min>'.date('Y').'-12-31</min>';
							echo '</range>';
						echo '</nights>';
					echo '</override>';
					echo '<override>';
						...
						echo '<nights>';
							echo '<range>';
								echo '<max>'.date('Y').'-01-01</max>';
								echo '<min>'.date('Y').'-02-28</min>';
							echo '</range>';
						echo '</nights>';
					echo '</override>';
				echo '</nightlyOverrides>';
