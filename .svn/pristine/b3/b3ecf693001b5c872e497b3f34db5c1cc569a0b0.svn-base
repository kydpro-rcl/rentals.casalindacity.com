...
<p>&nbsp;</p>
<p>&nbsp;</p>
<!--//<div style="background-color:#fcae69; border: 1px solid #F9A80B;"><strong>IMPORTANT INFORMATION:</strong><br/>
1.	Upon arrival, a credit card or a deposit of 75.00 USD per bedroom will be required to handle any damages or missing inventory.<br/>
<a style="color:red;" href="http://casalindacity.com/Assets/Head%20page/RCL%20Terms%20&%20Conditions.pdf" target="_blank">Terms and Conditions</a>
</div>//-->
...
<form method="post" action="booking_excursions.php">
<p style="text-align:right; padding-right:12px;"><input class="boton" type="submit" name="add" value="Add Services or Excursions"  /></p>
</form>