...
if ($_SESSION['info']){
 ...
 if ($_POST['ref']!=''){
    ...
    if (($o['status']==0)||($o['status']==5)||($o['status']==7)||($o['status']==1)||($o['status']==2)||($o['status']==3)||($o['status']==4)||($o['status']==6)||($o['status']==12)||($o['status']==13)||($o['status']==14)||($o['status']==7)||($o['status']==19)||($o['status']==20)||($o['status']==21)||($o['status']==26)||($o['status']==27)||($o['status']==28)||($o['status']==29)){
	...
	/* DO NOT PUT QUANTITIES TO MONTHLY PAYMENTS OR EXTRA NIGHTS ONLY PUT PRICE*/
	/*
