<? if(!$_POST){
	...
	$db= new getQueries ();
			...
			while (false!== ($file = readdir($d))) //Reads Directory
				{
											...
											<div class="row padall">
											  ...
											  <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
												...
												<div>
												  <h4><!--<span class="fa fa-map-marker icon"></span>--> Villa
													<?=$d['no']?> <?php
																$txt_class='';//empty when return
																	...
																	<span style="color:<?=$txt_class_color?>;font-weight:bold;margin-left:15px;"><?=$txt_class;?> <?php /*=$d['classification'];*/?></span>
												  </h4>
												  <h4>
												  <?php 
												  ...
												  ?>
													<?=number_format($avg_night)?> <small>avg/night</small> -  <?=number_format($total_amount)?> <small>Total (inc/tax)</small>
												  </h4>
												...
												<div class="pull-left">
												  <div class="row">
													<div class="col-xs-6 col-sm-4"> 
													  <!-- Large modal -->
													  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#show_calendar<?=$d['id']?>"  >Calendar</button>
													...
													<div class="col-xs-6 col-sm-4"><a   class="thumbnails" rel="lightbox[group<?=$d['no']?>]" href="../booking/<?=$d['pic']?>">
													  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal<?=$d['id']?>"> Pictures </button>
													  </a>
													...
													<div class="col-xs-6 col-sm-4">
													  <form class="form-inline" name="bookform" id="bookform2" method="post" action="client-details.php#content_starts">
														...
														<button type="submit" name="continue" class="btn btn-primary pull-left">Reserve</button>
													  </form>
													</div>
												  </div>
												</div>
...
<!--<form method="post" name="villa_disponible" action="booking_details.php">
						  ...
						  if(trim($_POST['referral'])!=''){?>
				           ...
				           <?}?>                                
					            ...
					            <div class="villas_detalles"  >
	                                   <div class="detalles1">
								          	<img  style="float:left; padding-right:5px;" src="../booking/<?=$d['pic']?>" alt="villa <?=$d['no']?>" title="villa <?=$d['no']?>" width="153" height="103"/>
								            <h1 style="margin:0; padding:0; margin-bottom:5px;"><b>Villa No.<?=$d['no']?></b> -  <span style="color:black; font-size:10px; line-height:10px;"><?=$d['head']?></span></h1>
								           	<?if ($LS_nights>0){?>
