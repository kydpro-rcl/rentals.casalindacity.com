				  ...
				  <!--<tr>
					...
					<tr>
						<td class="thinfield">
							 ...
							 <input class="btn btn-primary" style="margin-right:559px;" type="button" name="Cancel" value="Cancel" onclick="window.location = 'http://casalindacity.com' " />
							 <input type="submit" value="Pay Now" class="btn btn-primary" /></p>
						</td>
					</tr>
				</table>
			</center>
...
?>
		<div class="container">
	<?
		new_booking_busy_error($_SESSION['desde'], $_SESSION['hasta'], $link="../index.php");/*get error if villa is not available*/
...
?>
		<div class="container">
		<p> Error no villa Selected; to try again, please <a href="../index.php" alt="click to return">Click Here</a>
		 </div> 
		<? include('../template/footer.pp.php');?>
		<?
 }
