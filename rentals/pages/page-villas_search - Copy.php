...
<?php
	...
	//-----------------------END HIGHT AND LOW SEASONS QUANTITY-----------------------------------------------------------------------------
		...
		if(time()<(strtotime('2017-01-02'))){/*fi date min */
			//echo "Menor del 1";
			if(strtotime($empieza)<=(strtotime('2017-01-02'))){
				$minimu_stay=3;
			}else{
				$minimu_stay=2;
			}
											...
											<div class="row padall">
											  ...
											  <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
												...
												<div>
												 ...
												 ?>
													<span style="color:#333;"><strike>$<?=number_format($precio_anterior_sin_tax)?></strike> </span>
												 <?php } 
												 $avg_night_sin_tax=($avg_night/1.18);
												 ?>
												 
													<span style="color:#333;">$<?=number_format($avg_night_sin_tax)?></span> <small>avg/night</small> - 
												...
												?>	
													<span style="color:#333;">$<?=number_format($total_amount_sin_tax)?> </span><small>Total (+ 18% tax)</small>
												  </h4>
												  
												 
												  <?=readmore_villas($d['head']);?>
