...
<input type="hidden" name="referral" value="">
		...
		<!--<input type="hidden" name="show" value="1">-->
		  <!--<input type="hidden" name="promotion_code" value="">-->
			...
			<!--<form class="row" name="bookform" id="bookform" method="post" action="http://www.casalindarentals.com/vacation-rentals-homes-search.asp">-->
			<!--<form class="row" name="bookform" id="bookform" method="post" action="<?=$var_base?>vacation-rentals-search.php#content_starts">-->
			<form class="row" name="bookform" id="bookform" method="post" action="<?=$var_base?>vacation-villas-search.php#content_starts">
				...
				<div class="col-xs-12 col-sm-4 col-md-2">
					<select name="show" class="form-control">
						<!--<option value="1">Show all villas</option>-->
						<option value="0">Only available</option>
					</select>
				</div>
				<div class="col-xs-12 col-sm-4 col-md-2">
					<?php if($_GET['villa']!=''){
					...
					<nav class="navbar navbar-default">
					  <div class="container-fluid">
						...
						<div class="navbar-header">
						  ...
						  <a class="navbar-brand" href="../vacationrentals/index.php">Home</a>
						</div>

						<!-- Collect the nav links, forms, and other content for toggling -->
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						  <ul class="nav navbar-nav">
							<li ><a  href="../vacationrentals/index.php">Amenities <!--<span class="sr-only">(current)</span>--></a></li>
							<li><a  href="../vacationrentals/local-area-guide.php">Excursions</a></li>
							<li><a  href="../vacationrentals/index.php">Services</a></li>
							<li><a  href="../vacationrentals/driving-directions.php">Directions</a></li>
							<li><a  href="../vacationrentals/area-map.php">Maps</a></li>
							<li><a  target="_blank" href="http://sales.casalindacity.com">Sales</a></li>
