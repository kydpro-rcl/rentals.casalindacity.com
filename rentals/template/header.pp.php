...
<section class="big-banner-wrapper">
	<div id="main-slider" class="flex-set-height">
		<div id="mainFlexSlider" class="flexslider flexslider-clear">
			<ul class="slides">
				<li class="slide">
					<div class="flexslider-image-bg" style="background: url(<?=$var_base?>images/slider/4.jpg) center top no-repeat;"></div>
				...
				<li class="slide">
					<div class="flexslider-image-bg" style="background: url(<?=$var_base?>images/slider/3.jpg) center top no-repeat;"></div>
					<div class="flex-overlay"></div>
					<div class="flex-caption center">
				...
				<li class="slide">
					<div class="flexslider-image-bg" style="background: url(<?=$var_base?>images/slider/2.jpg) center top no-repeat;"></div>
					<div class="flex-overlay"></div>
					<div class="flex-caption center">
				...
				<li class="slide">
					<div class="flexslider-image-bg" style="background: url(<?=$var_base?>images/slider/6.jpg) center top no-repeat;"></div>
					<div class="flex-overlay"></div>
					<div class="flex-caption center">
				...
				<li class="slide">
					<div class="flexslider-image-bg" style="background: url(<?=$var_base?>images/slider/5.jpg) center top no-repeat;"></div>
					<div class="flex-overlay"></div>
					<div class="flex-caption center">
...
<input type="hidden" name="show" value="1">
		  <input type="hidden" name="promotion_code" value="">
			...
			<form class="row" name="bookform" id="bookform" method="post" action="<?=$var_base?>vacation-rentals-search.php#content_starts">
