...
function mostrar_calendario($mes,$ano,$villa_id){
	...
	echo '<table class="tablacalendario" cellspacing="3" cellpadding="2" border="0" style="border-left:#64c2fd 1px solid; border-right:#64c2fd 1px solid; border-top:#64c2fd 1px solid; border-bottom:#64c2fd 1px solid;">';
