   ...
   /*#//=====================================================================================================================
	...
	for ($i=0;$i<7;$i++){
		if ($i < $numero_dia){
            ...
            /*if ((strtotime($fecha_formato))<(strtotime(date('Y-m-d')))){
             ...
             if (in_array($fecha_formato,$fechas_villa_ocupada)){$pintar_con="disponible";}else{$pintar_con="disponible";}
            /*}*/
            /*#//---------------------------------------------------------------------------------------------- */
	...
	while ($dia_actual <= $ultimo_dia){
        ...
        /*if ((strtotime($fecha_formato2))<(strtotime(date('Y-m-d')))){           $pintar_con2="fecha_pasada";
         ...
         if (in_array($fecha_formato2,$fechas_villa_ocupada)){$pintar_con2="disponible";}else{$pintar_con2="disponible";}
        /*}
        #//-----------------------------------------------------------------------------------------------------------------------*/
