...
<p>Choose payment method</p>
    <li style="list-style:none; float:left;">
                                            ...
                                            <label for="payWithCC" class="clickable">
                                                <img src="../for_rent/images/cclogo.jpg"   alt="Credit Card" />
										...
										<table border=0><tr><td>
                                            ...
                                            <label for="payWithPP" class="clickable" style="position:relative; top:0px;">
                                                <img src="../for_rent/images/PPPPLOGO.jpg"  alt="PayPal" />
...
I Agree to <a href="http://www.casalindacity.com/Terms_and_conditions.php" target="_blank" alt="Terms and Conditions">Terms and Conditions.</a> &nbsp;<!--<input id="mybutton" type="submit" disabled="disabled" name="new_client"  value="Continue booking"  class="" />-->

<? if ($_SESSION['error']['agree']){?> <span id="error_s"><?=$_SESSION['error']['agree']?></span><?}?></p>
<p style="text-align:right; padding-right:12px; clear:both;"><input type="image" name="submit" src="../for_rent/images/Check_out_0.png" /></p>
</form>
