...
<a href="http://casalindacity.com/" alt="Go to our home page" title="Go to our home page"> <img src="images/logo.gif" alt="Residencial Casa Linda" border="0" /></a>
<?/*}else{?>
		 <img src="<?=$_SESSION['REFERRALLOGO']?>" alt="Residencial Casa Linda" width="209px" height="52px" border="0" />
<?}*/?>
