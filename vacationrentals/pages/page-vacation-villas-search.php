...
<?
							...
							//================================START SHOWING VILLAS NO AVAILABLE WHEN THERE IS SOME AVAILABLE STILL==========================
						...
						<?php
						}	/*END LOOP FOR EACH VILLA NO AVAILABLE*/					
						//================================END SHOWING VILLAS NO AVAILABLE WHEN THERE IS SOME AVAILABLE STILL==========================
				     }else{
						if(trim($_POST['uniqueVilla'])!=''){
