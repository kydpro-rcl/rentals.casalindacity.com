        ...
        if (!empty($servicios_reserva)){
		   ...
		   // echo $s['price']." ";
			   if (($s['type']=="Airport Pick Up") || ($s['type']=="VIP Airport Pick Up") ){
				echo "<P id='right_blue' style='font-size:13px'>".$s['name']." = ".$s['price']."</p>"; $total_services+=$s['price'];
			   }else{
				echo "<P id='right_blue' style='font-size:13px'>".ucfirst($s['type'])." (".$s['name'].")= ".$s['price']."</p>"; $total_services+=$s['price'];
			   }
...
<p style="clear:both"><input type="button" class="book_but" onclick="javascript:window.print()" value="Print" title="Print this page"> </p>
