		...
		if($_POST){
			...
			/*====================================empieza formulario general==================================================================*/
			 ...
			 /*====================================termina formulario============================================================*/
				...
				$res=mail('maintenance@casalindacity.com', $MailSubject, $MailBody, $MailHeader);//copia cliente
				$res=mail('alexander@casalindacity.com', $MailSubject, $MailBody, $MailHeader);//copia cliente
			    $res=mail('RCLMAINT@emaint.com', $MailSubject, $MailBody, $MailHeader);//copia cliente
				
				
				 /*================================= start save into db===============================*/
					$db= new subDB();
					$fields=array(	'desde'=>$_SESSION['info']['name']." ".$_SESSION['info']['lastname'],
									'email'=>$_SESSION['info']['email'],
									'villa'=>$_POST['villa_no'],
