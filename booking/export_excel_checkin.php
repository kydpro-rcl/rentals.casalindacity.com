...
echo "<div id=\"content\" >
 <div id=\"header_main\">
       	<p style=\"text-align:center; padding:0; margin:0;\"><img  src=\"https://www.casalindacity.com/booking/print_view/images/logo.png\" alt=\"logo\" /></p>
...
echo "<p class=\"header\">Booking System - Report of clients</p>
 <p id=\"p_date\">Printed by: ".$_SESSION['info']['name']." ".$_SESSION['info']['lastname']."<br/>Date printed: ".date('Y-m-d G:i:s');" </p>
...
echo "<table  align=\"center\" cellpadding=\"2\" cellspacing=\"0\" border=\"1\">";
	...
	echo "<tr class=\"title\">
		<td class='centro' id=\"td\">";
            ...
            echo "<a href=\"clients_list_print.php?sort=no\" title=\"Sort by numbers\">NO</a>";
			}else{
			echo "NO";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="status"){
            echo "<a href=\"clients_list_print.php?sort=status\" title=\"Sort by status\">STATUS</a>";
			}else{
			echo "STATUS";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="name"){
            echo "<a href=\"clients_list_print.php?sort=name\" title=\"Sort by names\">NAME</a>";
			}else{
			echo "NAME";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="name"){
            echo "<a href=\"clients_list_print.php?sort=name\" title=\"Sort by names\">LASTNAME</a>";
			}else{
			echo "LASTNAME";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="email"){
            echo "<a href=\"clients_list_print.php?sort=email\" title=\"Sort by emails\">EMAIL</a>";
			}else{
			echo "EMAIL";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="phone"){
            echo "<a href=\"clients_list_print.php?sort=phone\" title=\"Sort by phones\">PHONE</a>";
			}else{
			echo "PHONE";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
           ...
           echo " <a href=\"clients_list_print.php?sort=country\" title=\"Sort by countries\">COUNTRY</a>";
			}else{
			echo "COUNTRY";
			}
		echo "</td>
		<td class='centro' id=\"td\">";
			if ($_GET['sort']!="state"){
            echo "<a href=\"clients_list_print.php?sort=state\" title=\"Sort by cities\">STATE</a>";
			}else{
			echo "STATE";
			}
		echo "</td>
...
"<td id='td'>".utf8_decode($k['lastname'])."</td>".
"<td id='td'>".$k['email']."</td>".
"<td id='td'>".$k['phone']."</td>";
