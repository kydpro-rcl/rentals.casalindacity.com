...
function mostrar_calendario($mes,$ano,$villa_id){
	...
	echo '<table class="calendario table" cellspacing="3" cellpadding="2" border="0" style="border-left:#9c0000 1px solid; border-right:#9c0000 1px solid; border-top:#9c0000 1px solid; border-bottom:#9c0000 1px solid;">';
	echo '<tr><td colspan="7" class="tit">';
	//tabla para mostrar el mes el año y los controles para pasar al mes anterior y siguiente
	echo '<table class="table titmesano"  cellspacing="2" cellpadding="2" border="0"><tr><td class="text-center titmesano">';  //   class="messiguiente"
	...
	echo "<td class='text-center titmesano'>"; // class='mesanterior'
	...
	echo '	<tr>
			    <td width="14%" class="diasemana text-left" >Mon</td>
			    <td width="14%" class="diasemana text-left">Tue</td>
			    <td width="14%" class="diasemana text-left">Wed</td>
			    <td width="14%" class="diasemana text-left">Thu</td>
			    <td width="14%" class="diasemana text-left">Fri</td>
			    <td width="14%" class="diasemana text-left">Sat</td>
			    <td width="14%" class="diasemana text-left">Sun</td>
			</tr>';
   ...
   //=====================================================================================================================
	...
	for ($i=0;$i<7;$i++){
		if ($i < $numero_dia){
            ...
            //----------------------------------------------------------------------------------------------
			echo "<td " . dame_estilo($dia_actual) . " class='text-center' id=\"$pintar_con\" ><span>$dia_actual</span></td>";
			$dia_actual++;
		}
	}
	echo "</tr>";
	...
	while ($dia_actual <= $ultimo_dia){
        ...
        //-----------------------------------------------------------------------------------------------------------------------
		echo "<td " . dame_estilo($dia_actual) . " class='text-center' id=\"$pintar_con2\" ><span>$dia_actual</span></td>";
		$dia_actual++;
		$numero_dia++;
...
echo '
	...
	<table align="center" cellspacing="2" cellpadding="2" border="0" class="table">
	<tr>';
echo '
