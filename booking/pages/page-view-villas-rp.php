...
$villas = $data->showTable_restrinted("villas", "able_r=1" ,'id');
}else{
 /*switch ($_GET['sort']){
 case "no":
...
<?php
 ...
 ?>
		...
		<td class='centro' id="td">
			<?php if($k['wish_referal']==0){?> YES <?php }else{?> <span style="color:red">NO</span> <?php }?>
		</td>
		<td class='centro' id="td">
			<?php if($k['vonline']==0){?> YES <?php }else{?> <span style="color:red">NO</span> <?php }?>
		</td>
		<td class='centro' id="td">
			<?php if($k['wish_referal']==0){?> YES <?php }else{?> <span style="color:red">NO</span> <?php }?> - <?php if($k['vrap']==0){?> YES <?php }else{?> <span style="color:red">NO</span> <?php }?>
		</td>
