...
<p class="header">Printing Buyer invoice</p>
<hr />
<table align="center"><tr><td>
<fieldset><legend>Search booking</legend>
<form method="post" name="" action="invoices_buyer.php" target="_self" >
	...
	<? if ( $_POST['search']=="Go"){
	 ...
	 //=======================================================================================================
			...
			<tr bgcolor="#c9dbf3">
				   ...
				   case 6:
					...
					case 25:
			         	...
			         	$long=1;
				       	break;
					case 26:
			         	echo "<span class='r_long'>Checked in - Buyer</span>";
			         	$long=1;
				       	break;
					case 27:
			         	echo "<span class='r_long'>No confirmed- Buyer</span>";
			         	$long=1;
				       	break;
					case 28:
			         	echo "<span class='r_long'>Confirmed-Buyer</span>";
			         	$long=1;
				       	break;
					case 29:
			         	echo "<span class='r_long'>Checked Out - Buyer</span>";
			         	$long=1;
				       	break;
			       	default:
             ...
             <form method="post" name="" action="buyer_invoices_print.php" target="_blank" >
