...
<div id="content">
<p class="header" style="color:red;">Testing Text before Send Emails</p>
<!--<hr />-->
  ...
  <? if (!$_POST['send']){?>
	<form  method="post" name="RTEDemo" action="send_emails_clients_test_copy.php">
	<table><tr><td>
	...
	<tr><td colspan="2"><input class="book_but" type="submit" name="send" value="TEST" onClick="submitForm()" /></td></tr>
	</table>
...
//----------------------------------------------------------------------
 ...
 //-----------------------------------------------------------------------------------------
      ...
      $client_list=array(array('name'=>'Web Master', 'email'=>'webmaster@casalindacity.com'),array('name'=>'Joseluis', 'email'=>'webmaster@casalindacity.net'), array('name'=>'Joseluis', 'email'=>'ing.joseluis@msn.com'));
