...
$fecha_entrada=date('Y-m-d', $nextMonday);
	...
	$inhousema=count($db->inhouse_villas($date2=date('Y-m-d',$martes), $beds));
	$inhousemi=count($db->inhouse_villas($date3=date('Y-m-d',$miercoles), $beds));
	$inhouseju=count($db->inhouse_villas($date4=date('Y-m-d',$jueves), $beds));
	$inhousevi=count($db->inhouse_villas($date5=date('Y-m-d',$viernes), $beds));
	$inhousesa=count($db->inhouse_villas($date6=date('Y-m-d',$sabado), $beds));
	$inhousedo=count($db->inhouse_villas($date7=date('Y-m-d',$domingo), $beds));
	
	$Inhouse1=$db->inhouse_date($date);
	$Inhouse2=$db->inhouse_date($date2);
	$Inhouse3=$db->inhouse_date($date3);
	$Inhouse4=$db->inhouse_date($date4);
	$Inhouse5=$db->inhouse_date($date5);
	$Inhouse6=$db->inhouse_date($date6);
	$Inhouse7=$db->inhouse_date($date7);
	...
	<tr>
		<td ><strong><?=$inhouselu+1?></strong></td>
		<td ><strong><?=$inhousema+1?></strong></td>
		<td ><strong><?=$inhousemi+1?></strong></td>
		<td ><strong><?=$inhouseju+1?></strong></td>
		<td ><strong><?=$inhousevi+1?></strong></td>
		<td ><strong><?=$inhousesa+1?></strong></td>
		<td ><strong><?=$inhousedo+1?></strong></td>
	</tr>
</table>
