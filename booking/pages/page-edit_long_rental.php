 ...
 if ($_SESSION['info']){
  ...
  if ((validate_date($_POST['from']))&&(validate_date($_POST['to']))){
	 ...
	 $db= new subDB (); //CONNECT TO DATABASE
	    ...
	    $db->update_reserva($b['reserveid'], $ref, $b['busyid'], $id_customer, $adults_qty=0, $children_qty=0, $interm_id=0, $qty_nights,  $HS_nights, $LS_nights, $price_per_night=0, $priceHS=0, $amount_commision=0, $sub_total_rent=0, $ITBIS=0, $services_amount=0, $deposit=0, $general_amount=0, $status=8, $reasons);
       //echo $b['rc'];
		?>
           <p class="header">Editing Long Term Rental</p><hr />
     ...
     <div class="book_inserted4">
     	<h2>Long Term Rental successfuly Edited</h2>
