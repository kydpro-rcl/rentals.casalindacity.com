<?php
 if ($_SESSION['info']){
	 ...
	 $qty_nights=$_POST['nights'];  $reasons=$_POST['reasons']; $villa_no=$_POST['villa_no']; $id_customer=$_POST['customer'];
	 //VARIABLES END
...
//	<!--END NIGHTS FOR THIS RENT-->
	    ...
	    $ref=str_pad($id_ocupacion, 9, "0", STR_PAD_LEFT);
     	...
     	$id_reserve=$db->insert_short_reserva($ref, $id_ocupacion, $id_customer, $adults_qty=0, $children_qty=0, $interm_id=0, $qty_nights,  $HS_nights, $LS_nights, $price_per_night=0, $priceHS=0, $amount_commision=0, $sub_total_rent=0, $ITBIS=0, $services_amount=0, $deposit=0, $general_amount=0, $status=8, $reasons);

		?>
           <p class="header">Long Term Rental</p><hr />
     ...
     <div class="book_inserted2">
      	<p class="bloques2">Rental reference:<span class="info_details2"> <?=$ref?></span></p>
     </div><!--END SHOWING REF NUMBER-->

     <div class="book_inserted4">
     	<h2>Long Term Rental successfuly created</h2>
